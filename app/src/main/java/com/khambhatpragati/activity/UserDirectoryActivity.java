...
public class UserDirectoryActivity extends AppCompatActivity implements ItemClickListener {

    private static final String TAG = UserDirectoryActivity.class.getSimpleName();
    private RelativeLayout relativeLayout;
    private Toolbar toolbar;
    private RecyclerView recyclerView;
    private UserDirectoryAdapter mAdapter;
    ImageView imageView;
    private String selectedGroupId,strAdWeblink="";
    ...
    public void initToolBar() {
        ...
        toolbar.setTitle(R.string.activity_title_user_directory);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!strAdWeblink.equalsIgnoreCase("") && !strAdWeblink.equalsIgnoreCase("null")) {
                    Intent intent = new Intent(UserDirectoryActivity.this, WebviewActivity.class);
    ...
    private void getBottomAds() {
        final ProgressDialog progress = new ProgressDialog(UserDirectoryActivity.this);
        ...
        params.put("screen_type","UserDirectory Screen");
                            ...
                            for(int i=0;i<adsResponse.getData().size();i++){
                                if(formatter.parse(adsResponse.getData().get(i).getEnd_date()).after(formatter.parse(todayString))
                                    ...
                                    if(adsResponse.getData().get(i).getAdvertisement_type().equalsIgnoreCase("BottomAd")
                                            && adsResponse.getData().get(i).getScreen_type().equalsIgnoreCase("UserDirectory Screen")) {
                                        imageView.setVisibility(View.VISIBLE);
                                        strAdWeblink=adsResponse.getData().get(i).getWebsite_url();
                                        imageLoader = CustomVolleyRequest.getInstance(UserDirectoryActivity.this).getImageLoader();
    ...
    private void displayAllContacts() {
        DBHelper dbHelper = new DBHelper(UserDirectoryActivity.this);
        ...
        if (listOfUserDirectory != null && listOfUserDirectory.size() > 0) {
            ...
            mAdapter = new UserDirectoryAdapter(UserDirectoryActivity.this, sortedUsersList, selectedGroupId);
...
//        Log.d(TAG, "Unique Users: " + noRepeat.size());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (accessLevel != null && accessLevel.equals("2")) {
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add_user:
                Intent i = new Intent(UserDirectoryActivity.this, AddUserActivity.class);
                i.putExtra(KEY_GROUPS_ID, selectedGroupId);
                startActivity(i);
